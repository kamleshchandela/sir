    ...
    <div className='w-full py-16 bg-gray-50'>
      <div className='container mx-auto px-6 sm:px-12 md:px-24 lg:px-40'>
        ...
        <div className='text-center mb-12'>
          <h2 className='text-3xl md:text-4xl font-extrabold text-gray-900 mb-4'>Our Outstanding Portfolio</h2>
          <p className='text-gray-500 max-w-2xl mx-auto text-lg'>
            Explore some of our recent projects where we turned bold ideas into stunning digital realities.
          </p>
        </div>

        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 '>
          {
            workItems.map((val, index) => (
              <div 
                key={index} 
              ...
              >
                ...
                <div className='p-6 text-center bg-white relative'>
                    <h1 className='text-xl font-bold text-gray-800 mb-1'>{val.title}</h1>
                    <p className='text-amber-500 font-medium text-   tracking-wide uppercase'>{val.description}</p>
                </div>
